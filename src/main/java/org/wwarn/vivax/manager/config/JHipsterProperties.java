...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "VivaxDataManager@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "VivaxDataManager API";

        private String description = "VivaxDataManager API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "VivaxDataManager";
